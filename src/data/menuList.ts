export const menuItems = {
  drinks: [
    {
      name: 'Chach (Bottle)',
      image: '/images/menu/chach-bottle.webp',
      price: '₹60',
      description: 'A refreshing buttermilk drink, perfect for digestion.',
    },
    {
      name: 'Chach (Glass)',
      image: '/images/menu/chach-glass.webp',
      price: '₹20',
  ...
  mainCourse: [
    {
      name: 'Dal Bati',
      image: '/images/menu/dal-bati.webp',
      price: '₹70',
      description:
    ...
    },
    {
      ...
      price: '₹120',
      description: 'Sweetened crushed wheat dessert topped with dry fruits.',
    },
    {
      name: 'Laddu',
      image: '/images/menu/laddu.webp',
      price: '₹50',
